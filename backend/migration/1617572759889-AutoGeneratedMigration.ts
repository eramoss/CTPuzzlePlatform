...
export class AutoGeneratedMigration1617572759889 implements MigrationInterface {
    name = 'AutoGeneratedMigration1617572759889'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "test_application" ADD "description" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "user"."confirmationCode" IS NULL`);
        await queryRunner.query(`ALTER TABLE "test_application" DROP COLUMN "description"`);
    }
